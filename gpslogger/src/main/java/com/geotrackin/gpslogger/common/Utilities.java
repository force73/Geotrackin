...
import com.geotrackin.gpslogger.senders.ftp.FtpHelper;
...
public class Utilities {
    ...
    public static void ConfigureLogbackDirectly(Context context) {
        ...
        //final String LOG_DIR = "/sdcard/Geotrackin";
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        final String LOG_DIR = prefs.getString("gpslogger_folder", Environment.getExternalStorageDirectory() + "/Geotrackin");
    ...
    public static void PopulateAppSettings(Context context) {
        ...
        AppSettings.setFtpDirectory(prefs.getString("autoftp_directory", "Geotrackin"));
        ...
        AppSettings.setGpsLoggerFolder(prefs.getString("gpslogger_folder", Environment.getExternalStorageDirectory() + "/Geotrackin"));
